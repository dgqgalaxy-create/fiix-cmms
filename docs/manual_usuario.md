...
- **Avisos globales:** En **Notas y pendientes → Avisos**. Los ve todo el equipo. Solo un **Administrador** puede publicar (título, mensaje y foto opcional). Al abrir la pestaña se marcan como vistos; toca la foto para ampliarla dentro de la app. El Admin ve **Visto por X/Y** y la lista de personas. Push/in-app al publicar.
...
- **Ciclo de estado (acciones claras):** Pendiente → **Aceptar orden** (pasa a En Proceso). En Proceso → **Pausar** o **Finalizar**. En Espera → **Reanudar**. En móvil, al tocar la acción el botón se reemplaza por un aviso de confirmación («confirma con Guardar») hasta que guardes; puedes deshacer si te equivocaste.
