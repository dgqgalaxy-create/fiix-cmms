...
- **Capa móvil de técnico:** En celular, el rol Técnico ve una barra inferior con **Mi día**, Escanear QR, Inventario e Inicio. **Mi día** abre tus OT **pendientes** y **en espera** (pausadas); las **en proceso** quedan en **Mis Órdenes** (pulsa **Ver todas mis OT** en el listado). Al abrir una orden aparecen botones grandes de Aceptar / Pausar / Finalizar / Reanudar; completa evidencias y guarda. Administradores y gestionadores siguen con la interfaz completa (también en celular).
