...
- **Exportar:** Excel/CSV/PDF (**Carta** horizontal, tipografía compacta ~14–18 filas/hoja). Incluyen **Falla** (hasta 2 líneas en PDF), **Solicitante**, **Tipo** y **Paro máquina**; mismos filtros que la tabla. En el **PDF**, además de Orden / Falla·Equipo / Estado, aparecen las columnas **Solicitud** (alta), **Inicio** y **Fin** (dd/mm/aa; vacío si aún no aplica).
