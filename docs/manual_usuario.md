...
*(Versión 1.44.3 - 30 de Julio, 2026)*
...
- **Solo fotos de órdenes (sin reimportar CSV):** Si las OT ya están en la base, usa la tarjeta **Solo fotos de órdenes**: elige el zip + el CSV de Solicitudes y pulsa **Asignar fotos OT**. No hace falta volver a subir los 7 CSV.
