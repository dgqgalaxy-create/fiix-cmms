...
*(Versión 1.35.1 - 22 de Julio, 2026)*
...
- **PDF / Imprimir OC:** En el detalle de una Orden de Compra, **Descargar PDF / Imprimir** genera una hoja A4 vertical (retrato) con proveedor, líneas y totales (pedido y, si está Recibida, también recibido). Solo se imprime esa hoja — no el resto de la pantalla.
...
- **Exportar:** botón **Excel** (.xlsx real, lista filtrada), **CSV** y **PDF**/impresión.
