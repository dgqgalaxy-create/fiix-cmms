...
- **Capa móvil de técnico:** En celular, el rol Técnico ve una barra inferior con **Mi día**, Escanear QR, Inventario e Inicio. **Mi día** abre tus OT pendientes, en proceso y en espera (pausadas); en el listado puedes pulsar **Ver todas mis OT** para ver el resto de las asignadas. Al abrir una orden aparecen botones grandes de Aceptar / Pausar / Finalizar / Reanudar; completa evidencias y guarda. Administradores y gestionadores siguen con la interfaz completa (también en celular).
