...
- **Aviso de actualización:** Si en GitHub hay una versión más nueva que la del servidor, aparece un aviso (Admin/Gestionador ven la instrucción de `./update.sh`). Cuando el servidor ya se actualizó, la PWA pide **Recargar** para cargar el build nuevo.
