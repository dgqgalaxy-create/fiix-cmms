...
- **Exportar:** botón **Excel** (.xlsx real, lista filtrada), **CSV** y **PDF**/impresión (A4 horizontal compacto: folio, título/equipo, fecha y estado; ~10–15 órdenes por hoja). El PDF usa los mismos filtros que Excel/CSV (incluida la búsqueda por solicitante); no sale en blanco.
