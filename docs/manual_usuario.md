...
- **Unidades de medida:** En **Configuración → Unidades de Medida** (Administrador). Al crear una unidad puedes indicar si por defecto usa **enteros** o **decimales**. En cada repuesto eliges Unidad y **Cantidades** (Enteros / Decimales); movimientos, consumo en OT y OC respetan esa regla.
