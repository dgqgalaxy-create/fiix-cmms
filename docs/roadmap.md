...
## 🚀 Versión Actual: v1.43.11 (Actualización: 29 de Julio de 2026)

### Novedades en v1.43.11 (docs: Web Push y aviso de versión)
- **Docs:** README y manual detallan Web Push (VAPID, APIs, `push-sw.js`, cuándo se envía, troubleshooting) y el banner de actualización (`/api/version/status`, autoUpdate PWA, límites CasaOS/GitHub).
