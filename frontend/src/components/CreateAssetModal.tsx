            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {needsSection ? (
                  <>
                    <SearchableSelect
                      required
                      value={zoneSectionId}
                      onChange={setZoneSectionId}
                      options={zoneSections.map((s) => ({ value: s.id, label: s.name }))}
              ...
              <div>
                ...
                <SearchableSelect
                  required
                  value={assetKind}
                  onChange={(v) => setAssetKind(v as AssetKindValue)}
                  options={[
                    { value: 'FIJO', label: `${ASSET_KIND_LABELS.FIJO} (F)` },
                    { value: 'CONTROLABLE', label: `${ASSET_KIND_LABELS.CONTROLABLE} (C)` },
                  ]}
              ...
              <div>
                ...
                {isLoadingVendors ? (
                  ...
                  <SearchableSelect
                    ...
                    allowEmpty
                    emptyLabel="Sin proveedor registrado"
