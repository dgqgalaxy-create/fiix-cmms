        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-slate-100 text-slate-500 border border-slate-200 rounded-xl font-mono text-sm disabled:opacity-80"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-slate-100 text-slate-500 border border-slate-200 rounded-xl font-medium text-sm disabled:opacity-80"
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 bg-slate-100 border border-slate-200 rounded-xl font-bold text-sm disabled:opacity-80 ${transaction.amount > 0 ? 'text-emerald-600' : 'text-rose-600'}`}
              />
            </div>
          </div>
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-4 py-2.5 bg-slate-100 text-slate-500 border border-slate-200 rounded-xl text-sm disabled:opacity-80 resize-none"
            />
          </div>
        </div>

        <div className="mt-2 pt-6 border-t border-slate-100 flex justify-end gap-3 p-6">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 bg-blue-50 text-blue-600 font-semibold hover:bg-blue-100 rounded-xl transition-colors"
          >
            Cerrar
          </button>
        </div>
