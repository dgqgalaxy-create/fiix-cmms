...
const AVAILABLE_PERMISSIONS = [
  ...
  { key: 'DELETE_ITEMS', label: 'Eliminar Repuestos', description: 'Permite eliminar permanentemente repuestos. Si tiene movimientos, pregunta si también quieres eliminarlos; bloquea si tiene planes u órdenes de compra.' },
  { key: 'DELETE_INVENTORY_MOVEMENTS', label: 'Eliminar Movimientos de Inventario', description: 'Permite eliminar movimientos de inventario (revierte el stock). Se activa desde el menú de clic derecho en la pestaña Movimientos.' },
